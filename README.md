...
- Render image URLs and spreadsheet `IMAGE("...")` formulas on cards
...
- To show an image on a card, put an image URL/path by itself in the Term or Definition cell, or use a spreadsheet `IMAGE("...")` formula with a direct image URL
